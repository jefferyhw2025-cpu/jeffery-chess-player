...
https://jefferyhw2025-cpu.github.io/jeffery-chess-player/

- No admin page
- No admin password
- No local launcher scripts
- No private source repository history
- No developer-only feedback dashboard
